...
function AppContent() {
  ...
  return (
    <>
      ...
      <div className={`flex flex-col sm:flex-row h-screen bg-vyntra-bg text-vyntra-text font-sans overflow-hidden transition-opacity duration-700 ${isAppLoading ? 'opacity-0' : 'opacity-100'}`}>
