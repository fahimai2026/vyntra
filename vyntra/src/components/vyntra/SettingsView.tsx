              ...
              <div className="bg-white/5 rounded-2xl border border-white/5 p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button 
                    ...
                    className={`p-4 rounded-xl border flex flex-col items-center gap-2 transition-colors ${theme === "dark" ? 'border-vyntra-primary bg-vyntra-primary/10' : 'border-white/10 hover:bg-white/5'}`}
                  >
                    <div className="w-8 h-8 rounded-full bg-[#0B0F19] border border-white/20 flex items-center justify-center">
                      {theme === "dark" && <Check size={14} className="text-vyntra-primary" />}
                    </div>
                    <span className="font-bold">Dark Theme</span>
                  </button>
                  <button 
                    onClick={() => handleToggleTheme("light")}
                    className={`p-4 rounded-xl border flex flex-col items-center gap-2 transition-colors ${theme === "light" ? 'border-vyntra-primary bg-vyntra-primary/10' : 'border-white/10 hover:bg-white/5'}`}
                  >
                    <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center">
                      {theme === "light" && <Check size={14} className="text-vyntra-primary" />}
                    </div>
