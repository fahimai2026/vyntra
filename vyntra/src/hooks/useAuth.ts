...
export function useAuth() {
  ...
  return { user, loading, signInWithGoogle, signInWithGoogleRedirect, logout, loginWithEmail, signupWithEmail, updateUserBio, updateUserProfile, updateUserPreferences };
}
